    ...
    <table cellspacing="1" cellpadding="8" border="0" bgcolor="#999999">
      <tbody><tr>
        ...
        <td width="250" bgcolor="#FFFFFF"><input type="text" id="code" name="code" readonly="readonly" disabled="disabled"> </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF"><input type="hidden" id="isPR" name="isPR" value="0">
        					  <input type="checkbox" id="isPR" name="isPR" value="1">おすすめ商品棚に並べる
      ...
      <tr>
        <th bgcolor="#EBEBEB">おすすめ商品</th>
        <td bgcolor="#FFFFFF"><input type="checkbox" id="isPR" name="isPR" value="1" checked="checked">おすすめ商品棚に並べる
        </td>
      </tr>
      @endif
    </tbody></table><br>
    <input type="hidden" name="_token" value="{{csrf_token()}}">
    <input type="submit" value="登録する" onclick="if(confirm('商品を登録しますか？')){return true;}else{return false;}">
    </form>
